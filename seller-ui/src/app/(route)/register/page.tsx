...
const Register = () => {
  ...
  return (
    <div className="flex w-full flex-col items-center pt-10 min-h-screen">
      {/* {stepper} */}
      <div className="relative w-[90%] md:w-[60%] max-w-xl mb-8">
        <div className="absolute top-5 left-[16.6667%] right-[16.6667%] h-[2px] bg-gray-300 -z-10" />
        ...
        {!showOtp ? (
          ...
          <>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <label className="block text-gray-700 mt-3 mb-1">Phone Number</label>
              <input
                type="tel"
              ...
              />
              {errors.phone && (
                <p className="text-red-500 text-sm mb-2">{String(errors.phone.message)}</p>
              )}

              <label className="block text-gray-700 mt-3 mb-1">Country</label>
              <select
                defaultValue=""
                className="w-full px-4 py-3 bg-blue-50 border border-blue-100 rounded-lg outline-none focus:border-blue-400 transition-colors text-gray-800 mb-1"
                {...register("country", {
